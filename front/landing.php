...
<body id="homeSection">
  ...
  <main id="content" role="main">
    ...
    <div id="aboutSection" class="container space-2 space-lg-3">
      ...
      <!-- Browser Mockup -->
      <div class="position-relative w-lg-75 mx-lg-auto mb-4" data-aos="fade-up">
        <figure>
    ...
    <div id="pricingSection" class="container space-top-2 space-top-lg-3">
      ...
      <div class="w-lg-75 mx-lg-auto">
        <div class="row align-items-sm-end mx-n2 mb-5 mb-md-7">
          ...
          <div class="col-sm-6 col-md-4 px-2 mb-3 mb-md-0">
            <!-- Pricing -->
            <div class="card card-bordered shadow-none text-center" data-aos="fade-up" data-aos-delay="50">
              <div class="card-body">
                <figure class="text-center mb-2">
                  <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="60" height="60" viewBox="0 0 160 160">
          ...
          <div class="col-sm-6 col-md-4 px-2">
            <!-- Pricing -->
            <div class="card card-bordered shadow-none text-center" data-aos="fade-up">
              <div class="card-body">
                <figure class="text-center mb-2">
                  <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="60" height="60" viewBox="0 0 160 160">
      ...
      <div class="container space-2 space-lg-3">
        ...
        <div class="text-center">
          <a href="#">
            ...
            <span class="btn btn-xs btn-icon btn-soft-light shadow-soft rounded-circle mx-2">
              <i class="fas fa-angle-right"></i>
            </span>
    ...
    <!-- Hiring Section -->
    <div id="hiringSection" class="container space-2 space-lg-3">
      <!-- Title -->
      <div class="w-lg-65 text-center mx-auto mb-5 mb-sm-9">
      ...
      <div class="w-lg-75 mx-lg-auto mb-5 mb-md-7">
        <!-- Card -->
        <a class="card card-frame py-3 px-4 mb-3" href="./page-careers-single.html" data-aos="fade-up">
        ...
        <!-- Card -->
        <a class="card card-frame py-3 px-4 mb-3" href="./page-careers-single.html" data-aos="fade-up" data-aos-delay="50">
          <div class="row align-items-sm-center">
            <span class="col-sm-6 text-dark">
        ...
        <!-- Card -->
        <a class="card card-frame py-3 px-4 mb-3" href="./page-careers-single.html" data-aos="fade-up" data-aos-delay="100">
          <div class="row align-items-sm-center">
            <span class="col-sm-6 text-dark">
              Product Designer
            </span>
        ...
        <!-- Card -->
        <a class="card card-frame py-3 px-4 mb-3" href="./page-careers-single.html" data-aos="fade-up" data-aos-delay="150">
          <div class="row align-items-sm-center">
            <span class="col-sm-6 text-dark">
        ...
        <div id="map" class="min-h-300rem h-100 rounded-lg"
             data-hs-leaflet-options='{
               "map": {
                 ...
                 "coords": [-1.6583294093210719, 29.22040115206329]
               },
               "marker": [
                 {
                   "coords": [-1.6583294093210719, 29.22040115206329],
                   ...
                   "popup": {
                     "text": "56 Goma Institut supérieur d informatique et de gestion de Goma",
                     "title": "Address"
                   }
                 }
               ]
      ...
      <div class="col-sm-7 col-md-6 mb-4 mb-sm-0">
        ...
        <ul class="nav nav-sm nav-x-0 justify-content-center text-md-center">
          <li class="nav-item px-3">
            <a class="nav-link" href="page-about-agency.html">About</a>
          </li>
          <li class="nav-item px-3">
            <a class="nav-link" href="page-services-agency.html">Services</a>
          </li>
          <li class="nav-item px-3">
            <a class="nav-link" href="portfolio-single-page-list.html">Our work</a>
          </li>
        </ul>
        <!-- End Nav List -->
      </div>
