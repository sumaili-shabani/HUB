        ...
        t.HSCore.components.HSValidation = {
            ...
            init: function(e, s) {
                if (e.length) {
                    ...
                    n = t.extend(!0, a, n, i, s), e.hasClass("js-step-form") ? t.validator.setDefaults({
            ...
            highlight: function(e) {
                var s = t(e),
                    ...
                    o = s;
                void 0 !== n.data("validate-state") ? o = n : n.find("[data-validate-state]").length && (o = n.find("[data-validate-state]")), o.removeClass(i).addClass(a)
            },
            unHighlight: function(e) {
                var s = t(e),
                    ...
                    n = s.parents(".js-form-message").first(),
                    o = s;
                void 0 !== n.data("validate-state") ? o = n : n.find("[data-validate-state]").length && (o = n.find("[data-validate-state]")), o.removeClass(a).addClass(i)
            },
        ...
        t.HSCore.components.HSSelect2 = {
            ...
            init: function(e, s) {
                if (e.length) {
                    ...
                    var r = e.select2(o);
                    return e.siblings(".select2").find(".select2-selection").removeClass("select2-selection--single").addClass(o.customClass), o.singleMultiple && (a.singleMultiple(e, o), r.on("select2:select", (function(t) {
                        a.singleMultiple(e, o)
                    })), r.on("select2:unselect", (function(t) {
                        a.singleMultiple(e, o)
                    }))), a.safariAutoWidth(r, o), a.leftOffset(r, o), a.dropdownWidth(r, o), o.searchInputPlaceholder && a.searchPlaceholder(r, o), r
                }
            },
            ...
            singleMultiple: function(e, s) {
                ...
                i.removeClass("select2-selection--multiple"), e.find(":selected").length > 0 ? i.addClass(a.singleMultipleActiveClass) : i.removeClass(a.singleMultipleActiveClass), i.find(".select2-selection__rendered").replaceWith('<span class="select2-selection__rendered" role="textbox" aria-readonly="true"><span class="select2-selection__placeholder">' + n + '</span></span><span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span>')
            },
            ...
            init: function(e, s) {
                if (e.length && void 0 !== e.attr("data-hs-mask-options")) {
                    var a = Object.assign({}, this.defaults),
                        ...
                        n = {};
                    return n = t.extend(!0, a, n, i, s), e.mask(n.template, n)
                }
            }
        }
    }(jQuery),
        ...
        t.HSCore.components.HSClipboard = {
            ...
            init: function(e, s) {
                if (t(e).length) {
                    ...
                    o = t.extend(!0, i, n, o, s), n.contentTarget && this.setShortcodes(a, o);
                    var r = new ClipboardJS(e, o);
                    return r.on("success", (function() {
                        (o.successText || o.successClass) && (o.successText && ("tooltip" === o.type ? (a.attr("data-original-title", o.successText).tooltip("show"), a.on("mouseleave", (function() {
                            a.attr("data-original-title", o.title)
                        }))) : "popover" === o.type ? (a.attr("data-original-title", o.successText).popover("show"), a.on("mouseleave", (function() {
                            a.attr("data-original-title", o.title).popover("hide")
                        }))) : (a.get(0).lastChild.nodeValue = " " + o.successText + " ", setTimeout((function() {
                        ...
                        }), 800)) : (a.removeClass(o.defaultClass).addClass(o.successClass), setTimeout((function() {
        ...
        t.HSCore.components.HSSlickCarousel = {
            ...
            init: function(e, s) {
                if (e.length) {
                    ...
                    }, s), e.find("[data-slide-type]").length && a.videoSupport(e), e.on("init", (function(t, s) {
                    ...
                    var r = e.slick(o);
                    return t(o.asNavFor)[0] && t(o.asNavFor)[0].dataset.hsSlickCarouselOptions && JSON.parse(t(o.asNavFor)[0].dataset.hsSlickCarouselOptions).isThumbsProgress && a.setInitialDelay(e, o), e.on("beforeChange", (function(t, s, i, n) {
            ...
            transformOff: function(e, s, a, i) {
                var n = s;
                t(i.$slides).css("height", "auto"), n.isThumbs && n.slidesToShow >= t(i.$slides).length && e.addClass("slick-transform-off")
            },
            ...
            setCustomProgressCircle: function(e, s, a, i) {
                ...
                t(i.$slides).each((function(e) {
                    var s = t('<span class="slick-thumb-progress"><svg version="1.1" viewBox="0 0 160 160"><path class="slick-thumb-progress__path" d="M 79.98452083651917 4.000001576345426 A 76 76 0 1 1 79.89443752470656 4.0000733121155605 Z"></path></svg></span>'),
                        a = s.find("svg path");
                    o = parseInt(a[0].getTotalLength()), t(i.$slides[e]).children(n.thumbsProgressContainer).append(s)
                })), r.text(".slick-thumb-progress .slick-thumb-progress__path {opacity: 0;fill: transparent;stroke: " + n.thumbsProgressOptions.color + ";stroke-width: " + n.thumbsProgressOptions.width + ";stroke-dashoffset: " + o + ";stroke-dashoffset: 0px;}.slick-current .slick-thumb-progress .slick-thumb-progress__path {opacity: 1;-webkit-animation: " + (i.options.autoplaySpeed + i.options.speed) + "ms linear 0ms forwards dash;-moz-animation: " + (i.options.autoplaySpeed + i.options.speed) + "ms linear 0ms forwards dash;-o-animation: " + (i.options.autoplaySpeed + i.options.speed) + "ms linear 0ms forwards dash;animation: " + (i.options.autoplaySpeed + i.options.speed) + "ms linear 0ms forwards dash;}@-webkit-keyframes dash {from {stroke-dasharray: 0 " + o + ";} to {stroke-dasharray: " + o + " " + o + ";}}@-moz-keyframes dash {from {stroke-dasharray: 0 " + o + ";} to {stroke-dasharray: " + o + " " + o + ";}}@-moz-keyframes dash {from {stroke-dasharray: 0 " + o + ";} to {stroke-dasharray: " + o + " " + o + ";}}@keyframes dash {from {stroke-dasharray: 0 " + o + ";} to {stroke-dasharray: " + o + " " + o + ";}}"), r.appendTo(e)
            },
            ...
            setInitialDelay: function(t, e) {
                var s = e;
                t.slick("slickPause"), setTimeout((function() {
                    t.slick("slickPlay")
                }), s.initialDelay)
            },
            setCustomClasses: function(e, s, a, i, n) {
                ...
                })), l.length && (i > n ? (t(l[0].children).removeClass("slick-active-right"), t(l[0].children[n]).addClass("slick-active-right")) : t(l[0].children).removeClass("slick-active-right"), t(l[0].children).removeClass("slick-current"), setTimeout((function() {
            ...
            videoSupport: function(e) {
                e.length && e.on("beforeChange", (function(e, s, a, i) {
                    var n, o = t(s.$slides[a]).data("slide-type"),
                        ...
                        o = {
                            beforeShow: function(e) {
                                var s = t(e.$refs.bg[0]),
                                    ...
                                    o = i.overlayBg,
                                    r = i.overlayBlurBg;
                                n && a.css("visibility", "hidden"), o && s.css({
                                    backgroundColor: o
                            ...
                            afterShow: function(e) {
                                var s = t(e.current.$slide),
                                    ...
                                    i = e.current.opts.$orig[0].dataset.hsFancyboxOptions ? JSON.parse(e.current.opts.$orig[0].dataset.hsFancyboxOptions) : {},
                                    n = !!i.transitionEffectCustom && i.transitionEffectCustom;
                                n && (s.css("visibility", "visible"), s.hasClass("animated") || s.addClass("animated"), a && !a.hasClass("animated") && a.addClass("animated"), t("body").hasClass("fancybox-opened") ? (s.addClass(n.onShow), s.on("animationend webkitAnimationEnd oAnimationEnd MSAnimationEnd", (function(t) {
                                    s.removeClass(n.onShow)
                                })), a && (a.addClass(n.onHide), a.on("animationend webkitAnimationEnd oAnimationEnd MSAnimationEnd", (function(t) {
                                    a.removeClass(n.onHide)
                                })))) : (s.addClass(n.onShow), s.on("animationend webkitAnimationEnd oAnimationEnd MSAnimationEnd", (function(e) {
                                    s.removeClass(n.onShow), t("body").addClass("fancybox-opened")
                                }))))
                            },
                            beforeClose: function(e) {
                                ...
                                a.overlayBlurBg;
                                i && (s.removeClass(i.onShow).addClass(i.onHide), t("body").removeClass("fancybox-opened")), t("body").removeClass("fancybox-blur")
                            }
                        };
                        ...
                        n = {
                            onStart: function(e) {
                                ...
                                if (n.result_min_target_el && "single" === n.type ? t(n.result_min_target_el).is("input") ? t(n.result_min_target_el).val(e.from) : t(n.result_min_target_el).text(e.from) : (n.result_min_target_el || n.result_max_target_el && "double" === n.type) && (t(n.result_min_target_el).is("input") ? t(n.result_min_target_el).val(e.from) : t(n.result_min_target_el).text(e.from), t(n.result_min_target_el).is("input") ? t(n.result_max_target_el).val(e.to) : t(n.result_max_target_el).text(e.to)), n.grid && "single" === n.type && t(e.slider).find(".irs-grid-text").each((function(s) {
                                    ...
                                    for (var a = 0; a < n.secondary_val.steps.length; a++) e.from >= n.secondary_val.steps[a] && e.from < n.secondary_val.steps[a + 1] && (t(n.secondary_target_el).is("input") ? t(n.secondary_target_el).val(n.secondary_val.values[a]) : t(n.secondary_target_el).text(n.secondary_val.values[a]))
                                }
                            },
                            onChange: function(e) {
                                if (n.foreground_target_el) {
        ...
        t.HSCore.components.HSCircles = {
            ...
            init: function(e, s) {
                if (e.length) {
                    ...
                    (n = t.extend(a, n, i, s)).isViewportInit && (n.value = 0), this.setId(e, n.id);
                        ...
                        o = {
                            init: function() {
                                ...
                                e.on("addedfile", (function(e) {
                                    "image/" !== String(e.type).slice(0, 6) && t(e.previewElement).find(".dz-img").replaceWith('<span class="dz-file-initials">' + e.name.substring(0, 1).toUpperCase() + "</span>"), s.hide()
                                })), e.on("removedfile", (function() {
                                    e.files.length <= 0 && s.show()
                                }))
                            }
                        };
                    return "#" === (o = Object.assign({}, i, o, n, s)).previewTemplate[0] && (o.previewTemplate = t(o.previewTemplate).html()), new Dropzone(e, o)
                }
            }
        }
    }(jQuery),
    function(t) {
        t.HSCore.components.HSCountdown = {
            ...
            _preparePieItem: function(e, s) {
                ...
                i = t.extend(i, s), this.defaults.circlesIds.push(a), e.attr("id", "hs-countdown-element-" + a);
                var n = Circles.create(i);
                e.data("circle", n), i.fontSize && e.find("." + n._textClass).css("font-size", i.fontSize + "px")
            },
                                ...
                                yAxes: [{
                                    ticks: {
                                        callback: function(t, e, s) {
                                            ...
                                            return a && t > 100 && (t = t < 1e6 ? t / 1e3 + "k" : t / 1e6 + "kk"), i && o ? i + t + o : i ? i + t : o ? t + o : t
                                        }
                                    }
                                }]
                            },
                            ...
                            tooltips: {
                                custom: function(t) {
                                    ...
                                    if (s.classList.remove("above", "below", "no-transform"), t.yAlign ? s.classList.add(t.yAlign) : s.classList.add("no-transform"), t.body) {
                                        ...
                                        })), r += '</header><div class="hs-chartjs-tooltip-body">', i.forEach((function(e, s) {
                                            r += "<div>";
                                            var a = e[0],
                                                i = a,
                                                o = t.labelColors[s].backgroundColor instanceof Object ? t.labelColors[s].borderColor : t.labelColors[s].backgroundColor;
                                            r += (n.options.tooltips.hasIndicator ? '<span class="d-inline-block rounded-circle mr-1" style="width: ' + n.options.tooltips.indicatorWidth + "; height: " + n.options.tooltips.indicatorHeight + "; background-color: " + o + '"></span>' : "") + n.options.tooltips.prefix + (a.length > 3 ? i : e) + n.options.tooltips.postfix, r += "</div>"
                                        })), r += "</div>", s.querySelector(".hs-chartjs-tooltip").innerHTML = r
                                    }
                                    var l = this._chart.canvas.getBoundingClientRect();
                                    s.style.opacity = 1, n.options.tooltips.lineMode ? s.style.left = t.caretX + "px" : s.style.left = l.left + window.pageXOffset + t.caretX - s.offsetWidth / 2 - 3 + "px", s.style.top = l.top + window.pageYOffset + t.caretY - s.offsetHeight - 25 + "px", s.style.pointerEvents = "none", s.style.transition = n.options.tooltips.transition
                                }
                            }
                        }
                    ...
                    if ("line" === n.type && n.options.tooltips.lineMode) {
                        ...
                        o.draw = function(e) {
                            if (r.call(this, e), this.chart.tooltip._active && this.chart.tooltip._active.length) {
                                ...
                                t("#chartjsTooltip #chartjsTooltipLine").length || t("#chartjsTooltip").append('<div id="chartjsTooltipLine"></div>'), a.css({
                                    top: s.height() / 2 - a.height()
                                }), i.css({
                                    top: -(a.offset().top - s.offset().top) + o
                                }), a.offset().left + a.width() > s.offset().left + s.width() - 100 ? t(".hs-chartjs-tooltip").removeClass("hs-chartjs-tooltip-right").addClass("hs-chartjs-tooltip-left") : t(".hs-chartjs-tooltip").addClass("hs-chartjs-tooltip-right").removeClass("hs-chartjs-tooltip-left"), i.length && i.css({
                                    position: "absolute",
                                    width: "2px",
                                    height: s.height() - l,
                            ...
                            s.pageY - e.offset().top > t(".hs-chartjs-tooltip-wrap").height() / 2 && s.pageY - e.offset().top + t(".hs-chartjs-tooltip-wrap").outerHeight() / 2 < e.height() && (console.log(s.pageY + t(".hs-chartjs-tooltip-wrap").height() / 2 - (e.offset().top + e.height() / 2)), t(".hs-chartjs-tooltip").css({
