   ...
   <?php include('_script.php') ?>
    ...
    <div id="userModal" class="modal fade">
     ...
     $(document).ready(function() {
          ...
          {
           $.ajax({
            url:"<?php echo base_url(); ?>admin/upload_our_photos", //base_url() return http://localhost/tutorial/codeigniter/
            method:"POST",
            data:form_data,
            contentType:false,
            cache:false,
       ...
       {
        $.ajax({
         url:"<?php echo base_url(); ?>admin/pagination_galery_our_photos/"+page,
         method:"GET",
         dataType:"json",
          beforeSend:function()
          {
              ...
              if(idg !='')
                {
                   // alert("idg:"+idg);
                  $.ajax({
                          url:"<?php echo base_url(); ?>admin/supression_photo_galery_our_photos",
                          method:"POST",
                          data:{idg:idg},
                          success:function(data)
                          {
