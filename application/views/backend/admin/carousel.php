        ...
        <form method="post" id="user_form" enctype="multipart/form-data">
          <div class="modal-content">
                  ...
                  <div class="col-md-12">
                    <div class="row">
                      ...
                      <div class="form-group jf-inputwithicon col-md-12 description_bloc">
                          <label><i class="fa fa-edit"></i> Saisissez une expression</label>
                          <textarea class="form-control" name="description" id="description" placeholder="Saisissez une expression">
            ...
            <div class="modal-footer">
                ...
                <input type="hidden" name="idc" id="idc" placeholder="idc">
     ...
     $(document).ready(function(){  
      ...
      var  $message = '';
               ...
               if(description != '')
                {
                  ...
                  if (action =="Add") {
                      ...
                      $.ajax({  
                           url:"<?php echo base_url() . 'admin/operation_carousel'?>",  
                           method:'POST',  
                  ...
                  if (action == 'Edit') {
                        ...
                        $.ajax({  
                             url:"<?php echo base_url() . 'admin/modification_carousel'?>",  
                             method:'POST',  
                             data:new FormData(this),  
                             contentType:false,  
                             processData:false,  
          ...
          $(document).on('click', '.update', function(){  
               ...
               $.ajax({  
                    url:"<?php echo base_url(); ?>admin/fetch_single_carousel",  
                    method:"POST",  
                    data:{idc:idc},  
                    dataType:"json",  
                    success:function(data)  
                    {  
                         ...
                         $('.modal-title').text("modification du carousel  "+data.description);  
          ...
          $(document).on('click', '.delete', function(){
              ...
              if(confirm("Are you sure you want to delete this?"))
              {
                  ...
                  $.ajax({
                        url:"<?php echo base_url(); ?>admin/supression_carousel",
                        method:"POST",
                        data:{idc:idc},
                        success:function(data)
                        {
        ...
        const showSuccessMessage = function(message) {
          ...
          function filtrage(nombre){
            $.ajax({
             url:"<?php echo base_url(); ?>admin/pagination_view_carousel/"+nombre,
             method:"GET",
          ...
          {
            $.ajax({
             url:"<?php echo base_url(); ?>admin/pagination_view_carousel",
             method:"GET",
         ...
         {
            $.ajax({
             url:"<?php echo base_url(); ?>admin/fetch_search_view_carousel",
             method:"POST",
             data:{query:query},
              beforeSend:function()
              {
