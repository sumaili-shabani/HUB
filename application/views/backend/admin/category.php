    ...
    <script type="text/javascript" language="javascript" >  
     $(document).ready(function(){  
          ...
          var dataTable = $('#user_data').DataTable({  
               ...
               "order":[],  
               "ajax":{  
                    url:"<?php echo base_url() . 'admin/fetch_category_news'; ?>",  
                    type:"POST"  
               },  
               "columnDefs":[  
                    {  
               ...
               if(nom != '')
                {
                  ...
                  if (action =="Add") {
                      ...
                      $.ajax({  
                           url:"<?php echo base_url() . 'admin/operation_category_news'?>",  
                           method:'POST',  
                  ...
                  if (action == 'Edit') {
                        ...
                        $.ajax({  
                             url:"<?php echo base_url() . 'admin/modification_category_news'?>",  
                             method:'POST',  
                             data:new FormData(this),  
                             contentType:false,  
                             processData:false,  
          ...
          $(document).on('click', '.update', function(){  
               ...
               $.ajax({  
                    url:"<?php echo base_url(); ?>admin/fetch_single_category_news",  
                    method:"POST",  
                    data:{idcat:idcat},  
                    dataType:"json",  
                    success:function(data)  
          ...
          $(document).on('click', '.delete', function(){
               ...
               if(confirm("Are you sure you want to delete this?"))
	          {
	           		 ...
	           		 $.ajax({
                          url:"<?php echo base_url(); ?>admin/suppression_category_news",
                          method:"POST",
                          data:{idcat:idcat},
                          success:function(data)
                          {
