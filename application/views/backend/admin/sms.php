                                               ...
                                               <ul class="navbar-nav ml-auto">
                                                ...
                                                <li class="nav-item dropdown no-arrow">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                                        ...
                                                        <a class="dropdown-item" href="<?php echo(base_url())?>admin/sms">
  ...
  <script type="text/javascript">
   ...
   <script type="text/javascript">
     $(document).ready(function($) {
          ...
          {
            $.ajax({
              url:"<?php echo base_url(); ?>admin/pagination_message_sender/"+page,
              method:"GET",
              dataType:"json",
              beforeSend:function()
              {
          ...
          {
            $.ajax({
             url:"<?php echo base_url(); ?>admin/search_message_sender",
             method:"POST",
             data:{query:query},
              beforeSend:function()
              {
          ...
          $(document).on('click', '.delete', function(){
              ...
              if(confirm("Etes-vous sûre de vouloir le supprimer?"))
              {
                  ...
                  $.ajax({
                      url:"<?php echo base_url(); ?>admin/supression_message_sender",
                      method:"POST",
                      data:{idsms:idsms},
                      success:function(data)
                      {
          ...
          $(document).on('click', '.renvoyer', function(){
              ...
              if(confirm("Etes-vous sûre de vouloir le renvoyer?"))
              {
                  ...
                  $.ajax({
                      url:"<?php echo base_url(); ?>admin/renvoie_message_sender",
                      method:"POST",
                      data:{idsms:idsms},
                      beforeSend:function()
                      {
          ...
          function load_sms_sender_users_by_role(page)
          {
            ...
            if (idrole !='') {
                ...
                $.ajax({
                  url:"<?php echo base_url(); ?>admin/pagination_message_users_byrole/"+page,
                  method:"POST",
                  dataType:"json",
                  data:{idrole:idrole},
                  beforeSend:function()
