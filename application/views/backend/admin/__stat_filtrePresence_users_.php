...
<div class="col-md12">
	<div class="row">
		...
		<div class="col-md-12 row">
			...
			<div class="col-md-8">
				<div class="col-md-12">
					<form class="row" method="post" action="<?php echo(base_url()) ?>admin/statPresenceEntreprise">

						<div class="col-2 mb-4">
							<a href="<?php echo(base_url()) ?>admin/<?php echo($url) ?>" target="_blank" class="btn btn-primary btn-sm"><i class="fa fa-print"></i>PDF</a>
						</div>
