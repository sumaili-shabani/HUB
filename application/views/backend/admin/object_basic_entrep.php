...
<div class="col-md-12">
	...
	<!-- form commence -->
	<form method="post" id="user_form" enctype="multipart/form-data" action="<?= base_url(); ?>admin/modification_panel_entreprise">
	<div class="col-lg-12">
		<div class="row">
		...
		<div class="col-md-6">
	        ...
	        <div class="col-md-12 mb-2">
	        	...
	        	<textarea name="description" class="form-control textarea" placeholder="La description de l'entreprise" rows="5">
