     ...
     $(document).ready(function(){  
       ...
       var  $message = '';
               ...
               var action = $('#action').val();
                ...
                if(titre != '' && description != '')
                {
                  ...
                  if (action =="Add") {
                      ...
                      $.ajax({  
                           url:"<?php echo base_url() . 'admin/operation_module'?>",  
                           method:'POST',  
                  ...
                  if (action == 'Edit') {
                        ...
                        $.ajax({  
                             url:"<?php echo base_url() . 'admin/modification_module'?>",  
                             method:'POST',  
                             data:new FormData(this),  
                             contentType:false,  
                             processData:false,  
          ...
          $(document).on('click', '.update', function(){  
               ...
               $.ajax({  
                    url:"<?php echo base_url(); ?>admin/fetch_single_module",  
                    method:"POST",  
          ...
          $(document).on('click', '.delete', function(){
              ...
              if(confirm("Are you sure you want to delete this?"))
              {
                  ...
                  $.ajax({
                      url:"<?php echo base_url(); ?>admin/suppression_module",
                      method:"POST",
                      data:{idmodule:idmodule},
                      success:function(data)
                      {
          ...
          {
            $.ajax({
             url:"<?php echo base_url(); ?>admin/pagination_view_module/"+page,
             method:"GET",
             dataType:"json",
              beforeSend:function()
              {
         ...
         {
            $.ajax({
             url:"<?php echo base_url(); ?>admin/fetch_search_view_module",
             method:"POST",
             data:{query:query},
              beforeSend:function()
              {
