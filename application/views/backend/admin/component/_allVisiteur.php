                                 ...
                                 <tr role="row" class="odd">
                                    <td>
                                        ...
                                        if ($key['email'] !=='') {
                                            ...
                                            <div class="table-actions">
                                               ...
                                               &nbsp;
                                                <a onclick="return confirm('êtes-vous sûre de vouloire  l\'accepter d\'integrer l\'incubateur?');" href="<?php echo(base_url()) ?>admin/valider_visiteur/<?php echo($key['id']) ?>" class="btn btn-success btn-circle invvalider_liste btn-sm"><i class="fa fa-check"></i></a>
                                    ...
                                    <td class="sorting_1"><?php echo(nl2br(substr(date(DATE_RFC822, strtotime($key['created_at'])), 0, 23))) ?></td>
                                      ...
                                      <td class="sorting_1">
                                        ...
                                        <a onclick="return confirm('êtes-vous sûre de vouloire  rejeter sa demande?');" href="<?php echo(base_url()) ?>admin/delete_visiteur/<?php echo($key['id']) ?>"  class="btn btn-danger btn-circle btn-sm"><i class="fa fa-trash text-white"></i></a>
