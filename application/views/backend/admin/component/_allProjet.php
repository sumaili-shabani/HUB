                	    ...
                	    <td>
                	    	...
                	    	if ($key['email'] !=='') {
                	    		...
                	    		<div class="table-actions">
                                   ...
                                   &nbsp;
                                    <a href="<?php echo(base_url()) ?>admin/operationProjet/detail/<?php echo($key['codeP'])?>" email="<?php echo($key['email']) ?>" class="btn btn-warning btn-circle invvalider_liste btn-sm"><i class="fa fa-edit"></i></a>

                                     &nbsp;
                                    <a onclick="return confirm('êtes-vous sûre de vouloire supprimer ce projet?');"
                                    href="<?php echo(base_url()) ?>admin/operationProjet/suppression/<?php echo($key['codeP'])?>" class="btn btn-danger btn-circle  btn-sm"><i class="fa fa-trash"></i></a>
                                </div>
                	    		<?php
                	    	}
                	    	else{
                        ...
                        <td class="sorting_1"><?php echo(nl2br(substr(date(DATE_RFC822, strtotime($key['created_at'])), 0, 23))) ?></td>
                          ...
                          <td class="sorting_1">
                         	...
                         	<div class="table-actions">
                                ...
                                <a href="<?php echo(base_url()) ?>admin/pdf_projet/<?php echo($key['codeP']) ?>"  class="btn btn-primary btn-circle btn-sm"><i class="fa fa-print text-white"></i></a>
                            </div>
