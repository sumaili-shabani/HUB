<div class="col-md-12">
	<form class="row" method="post" enctype="multipart/form-data" action="<?= base_url(); ?>entreprise/operationProjet/ajout">
		...
		<div class="col-md-12 mb-4">
			<input type="submit" name="valider" id="valider" value="Soumettre votre projet" class="btn btn-secondary btn-block">
			<hr>
		</div>
