			                   		...
			                   		<div class="col-md-8">
				                    	...
				                    	<div class="col-md-12">
				                        	<div class="row">
				                        		...
				                        		<div class="col-md-8">
				                        			 <div for="files" class="text-center"><i class="fa fa-picture-o"></i>&nbsp; Selectionnez multiples photos de partenaires</div>
				                            ...
				                            <div class="col-md-12 col-lg-12" style="margin-top: 10px;">
				                         	...
				                         	<div class="form-group col-md-12" style="margin-top: 10px;">
				                         		<div class="row">
				                         			...
				                         			<div class="col-md-6">
				                         				<button type="submit" name="download" class="btn btn-hub btn-block"> <i class="fa fa-save fa-lg"></i> &nbsp; Sauvegarder dans le le dossier</button>&nbsp;
		  ...
		  $(document).on('click', '.update', function(){  
               ...
               $.ajax({  
                    ...
                    {  
                         ...
                         $('.modal-title').text("modification de url de partenaire");  
                         $('#idg').val(idg);   
                         $('#action').val("Edit");  
                    }  
               });  
