                        ...
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                    Nombre total de mes projets</div>
                                <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo($nombre_client); ?></div>
                            </div>
                            <div class="col-auto">
                                <a href="<?php echo(base_url()) ?>entreprise/newprojet">
                        ...
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                    Nombre total  de mes  paiements </div>
            ...
            <div class="col-xl-3 col-md-6 mb-4">
                <div class="card border-left-info shadow h-100 py-2">
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Nombre total d'opérations sur mon busness plan
                                </div>
                                <div class="row no-gutters align-items-center">
                                    <div class="col-auto">
                                        <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800"><?php echo($nombre_canavas); ?></div>
                                    </div>
                                    <div class="col">
                            ...
                            <div class="col-auto">
                                <a href="<?php echo(base_url()) ?>entreprise/canavas">
                        ...
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">
                                    Nombre total d'opérations réalisées sur mon tableau swot </div>
                                <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo($nombre_swot); ?></div>
                            </div>
                            <div class="col-auto">
                                <a href="<?php echo(base_url()) ?>entreprise/swot">
