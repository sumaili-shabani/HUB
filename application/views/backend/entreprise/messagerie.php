...
<script type="text/javascript">
  $(document).ready(function() {
     ...
     $(document).on('click', '.editer_message', function(event){  
               ...
               var code = $(this).attr("code");  
               $.ajax({  
                    url:"<?php echo base_url(); ?>entreprise/fetch_single_message",  
                    method:"POST",  
                    data:{code:code},  
                    dataType:"json",  
                    success:function(data)  
               ...
               var action = $('#action').val();
                ...
                if(message != '')
                {
                  if (action == 'Edit') {
                        ...
                        $.ajax({  
                             url:"<?php echo base_url() . 'entreprise/modification_message'?>",  
                             method:'POST',  
          ...
          $(document).on('click', '.supprimer_message', function(event){
              ...
              if(confirm("Etes-vous sûr de vouloir le supprimer?"))
              {
                  ...
                  $.ajax({
                        url:"<?php echo base_url(); ?>entreprise/supression_message",
                        method:"POST",
                        data:{code:code},
                        success:function(data)
                        {
