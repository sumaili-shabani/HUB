          ...
          foreach ($message->result_array() as $not) {
            ...
            <div class="media text-muted pt-3">
                ...
                <div class="pull-right">
                    <a href="<?php echo(base_url()) ?>comptable/chat_admin/<?php echo($id) ?>/<?php echo($not['id_user']) ?>" class="btn btn-default btn-sm"><i class="fa fa-comment mr-1"></i>chat</a>

                    <a onclick="return confirm('Etes-vous sûre de vouloire Supprimer ce message?')" href="<?php echo(base_url()) ?>comptable/view_1/display_delete_message/<?php echo($id) ?>/<?php echo($not['idmessage']) ?>" class="btn btn-default btn-sm"><i class="fa fa-trash mr-1"></i> supprimer</a> 
               </div>
            </div>
