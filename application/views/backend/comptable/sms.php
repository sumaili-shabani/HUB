                                               ...
                                               <ul class="navbar-nav ml-auto">
                                                ...
                                                <li class="nav-item dropdown no-arrow">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                                        ...
                                                        <a class="dropdown-item" href="<?php echo(base_url())?>comptable/sms">
  ...
  <script type="text/javascript">
   ...
   <script type="text/javascript">
     $(document).ready(function($) {
          ...
          {
            $.ajax({
              url:"<?php echo base_url(); ?>comptable/pagination_message_sender/"+page,
              method:"GET",
              dataType:"json",
              beforeSend:function()
              {
          ...
          {
            $.ajax({
             url:"<?php echo base_url(); ?>comptable/search_message_sender",
             method:"POST",
             data:{query:query},
              beforeSend:function()
              {
          ...
          $(document).on('click', '.delete', function(){
              ...
              if(confirm("Etes-vous sûre de vouloir le supprimer?"))
              {
                  ...
                  $.ajax({
                      url:"<?php echo base_url(); ?>comptable/supression_message_sender",
                      method:"POST",
                      data:{idsms:idsms},
                      success:function(data)
                      {
          ...
          $(document).on('click', '.renvoyer', function(){
              ...
              if(confirm("Etes-vous sûre de vouloir le renvoyer?"))
              {
                  ...
                  $.ajax({
                      url:"<?php echo base_url(); ?>comptable/renvoie_message_sender",
                      method:"POST",
                      data:{idsms:idsms},
                      beforeSend:function()
                      {
          ...
          {
            $.ajax({
              url:"<?php echo base_url(); ?>comptable/pagination_message_users/"+page,
              method:"GET",
              dataType:"json",
              beforeSend:function()
              {
          ...
          {
            $.ajax({
             url:"<?php echo base_url(); ?>comptable/search_message_users",
             method:"POST",
             data:{query:query},
              beforeSend:function()
              {
          ...
          function load_sms_sender_users_by_role(page)
          {
            ...
            if (idrole !='') {
                ...
                $.ajax({
                  url:"<?php echo base_url(); ?>comptable/pagination_message_users_byrole/"+page,
                  method:"POST",
                  dataType:"json",
                  data:{idrole:idrole},
                  beforeSend:function()
                  ...
                  if (message !='') {
                    // alert(sujet+" message "+message);
                      ...
                      if(checkbox.length > 0)
                      {
                           ...
                           $.ajax({
                                url:"<?php echo base_url(); ?>comptable/infomation_telephone",
                                method:"POST",
                                data:{
