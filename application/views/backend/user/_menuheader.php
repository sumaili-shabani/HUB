    ...
    <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown no-arrow mx-1">
            ...
            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                ...
                <?php
                     ...
                     if ($message->num_rows() > 0) {
                      ...
                      foreach ($message->result_array() as $not5) {
                        ...
                        <a class="dropdown-item d-flex align-items-center" href="<?php echo(base_url()) ?>user/chat_admin/<?php echo($connected) ?>/<?php echo($not5['id_user']) ?>">
                            <div class="mr-3">
                       ...
                       if ($message_chat_groupe->num_rows() > 0) {
                        ...
                        foreach ($message_chat_groupe->result_array() as $not6) {
                          if ($not6['id_user'] != $connected) {
                            ...
                            <a class="dropdown-item d-flex align-items-center" href="<?php echo(base_url()) ?>user/chat_admin2/<?php echo($connected) ?>/<?php echo($not6['code']) ?>">
                                <div class="mr-3">
                                    <div class="icon-circle bg-hub">
                ...
                <a class="dropdown-item text-center small text-gray-500" href="<?php echo(base_url()) ?>user/message">Voir tous les messages</a>
            </div>
        </li>
