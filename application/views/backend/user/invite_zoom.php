        ...
        <div class="modal-dialog modal-dialog-centered modal-sm" role="document">
            <div class="modal-content">
              ...
              <div class="modal-header bg-hub text-center">
                    <span class="nk-block-title modal-title text-white">Paramètrage user</span>
      ...
      $(document).ready(function() {
          ...
          $(document).on('click', '.delete', function(event){
              ...
              if(confirm("Etes-vous sûre de vouloir le supprimer à la cette conférence?"))
              {
                  ...
                  $.ajax({
                      url:"<?php echo base_url(); ?>user/supression_invite",
                      method:"POST",
          ...
          {
            $.ajax({
              url:"<?php echo base_url(); ?>user/pagination_invite_client/"+page,
              method:"GET",
              dataType:"json",
              beforeSend:function()
              {
          ...
          {
            $.ajax({
             url:"<?php echo base_url(); ?>user/search_invite_client",
             method:"POST",
             data:{query:query},
              beforeSend:function()
              {
          ...
          function detail_user(id_user){
            ...
            if (id_user !='') {
              ...
              $.ajax({  
                    url:"<?php echo base_url(); ?>user/fetch_single_personne_zoom",  
                    method:"POST",  
                    data:{id:id_user},  
                    dataType:"json",  
                    success:function(data)  
          ...
          */
          ...
          {
            $.ajax({
              url:"<?php echo base_url(); ?>user/pagination_message_users_zoom/"+page,
              method:"GET",
              dataType:"json",
              beforeSend:function()
              {
          ...
          {
            $.ajax({
             url:"<?php echo base_url(); ?>user/search_message_users_zoom",
             method:"POST",
             data:{query:query},
              beforeSend:function()
              {
          ...
          function load_sms_sender_users_by_role(page)
          {
            ...
            if (idrole !='') {
                ...
                $.ajax({
                  url:"<?php echo base_url(); ?>user/pagination_message_users_byrole_zoom/"+page,
                  method:"POST",
                  dataType:"json",
                  data:{idrole:idrole},
                  beforeSend:function()
                ...
                if (idconference !='' && link !='') {
                  // alert(idconference+" link "+link);
                    ...
                    if(checkbox.length > 0)
                    {
                         ...
                         $.ajax({
                              url:"<?php echo base_url(); ?>user/infomation_zoom",
                              method:"POST",
                              data:{
