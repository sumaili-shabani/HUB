...
<script type="text/javascript">
  $(document).ready(function() {
     ...
     $(document).on('click', '.editer_message', function(event){  
               ...
               $.ajax({  
                    url:"<?php echo base_url(); ?>user/fetch_single_chat_groupe",  
                    method:"POST",  
                    data:{code:idgroupe},  
                    dataType:"json",  
                    success:function(data)  
               ...
               var action = $('#action').val();
                ...
                if(message != '')
                {
                  if (action == 'Edit') {
                        ...
                        $.ajax({  
                             url:"<?php echo base_url() . 'user/modification_chat_message'?>",  
                             method:'POST',  
          ...
          $(document).on('click', '.supprimer_message', function(event){
              ...
              if(confirm("Etes-vous sûr de vouloir le supprimer?"))
              {
                      ...
                      $.ajax({
                        url:"<?php echo base_url(); ?>user/supression_chat_message",
                        method:"POST",
