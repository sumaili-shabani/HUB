...
<body id="page-top">
   ...
   <script type="text/javascript">
        $(document).ready(function() {
             ...
             {
              $.ajax({
               url:"<?php echo base_url(); ?>user/pagination_candidat_liste/"+page,
               method:"GET",
               dataType:"json",
             ...
             {
                  $.ajax({
                   url:"<?php echo base_url(); ?>user/fetch_search_candidat_pagination",
                   method:"POST",
                   data:{query:query},
                    beforeSend:function()
                    {
            ...
            $(document).on('click','.idp', function(){
              ...
              $.ajax({
                url:"<?php echo base_url(); ?>user/show_candidat_by_province",
                method: "POST",
                data:{
                  idp: idp
                },
             ...
             $(document).on('click','.idv', function(){
              ...
              $.ajax({
                url:"<?php echo base_url(); ?>user/show_candidat_by_ville",
                method: "POST",
                data:{
                  idv: idv
                },
            ...
            $(document).on('click','.idcat', function(){
              ...
              $.ajax({
                url:"<?php echo base_url(); ?>user/show_candidat_by_category",
                method: "POST",
                data:{
                  idcat: idcat
                },
    ...
    $(document).ready(function(){
      var sample_data = new Bloodhound({
       ...
       prefetch:'<?php echo base_url(); ?>user/fetch_auto',
       remote:{
        url:'<?php echo base_url(); ?>user/fetch_auto/%QUERY',
        wildcard:'%QUERY'
       }
      });
