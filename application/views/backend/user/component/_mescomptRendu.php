                	    ...
                	    <td>
                	    	...
                	    	if ($key['email'] !=='') {
                	    		...
                	    		<div class="table-actions">
                                   ...
                                   &nbsp;
                                    <a href="<?php echo(base_url()) ?>user/operationCompteRendu/detail/<?php echo($key['codeP'])?>" email="<?php echo($key['email']) ?>" class="btn btn-hub btn-circle btn-sm"><i class="fa fa-edit"></i></a>
                        ...
                        <td>
                          ...
                          <td class="sorting_1">
                         	...
                         	<div class="table-actions">
                                ...
                                href="<?php echo(base_url()) ?>user/operationCompteRendu/suppression/<?php echo($key['codeP'])?>"  class="btn btn-danger btn-circle btn-sm"><i class="fa fa-trash text-white"></i></a>
                            </div>
