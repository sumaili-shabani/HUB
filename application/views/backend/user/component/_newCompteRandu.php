<div class="col-md-12">
	<form class="row" method="post" enctype="multipart/form-data" action="<?= base_url(); ?>user/operationCompteRendu/ajout">
		<div class="col-md-12">
        ...
        <div class="col-md-6 mb-2">
        	...
        	<input type="text" name="milieu" class="form-control" placeholder="Milieu du terrain descendu">
        </div>
		...
		<div class="col-md-12 mb-2">
        	...
        	<button type="submit" name="valider" class="btn btn-hub btn-block"><i class="fa fa-send mr-1"></i> Envoyer</button>
        </div>
