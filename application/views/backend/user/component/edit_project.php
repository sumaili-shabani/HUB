<div class="col-md-12">
	<div class="row">
		...
		<div class="col-md-4"></div>
		<div class="col-md-4">
			<a href="<?= base_url() ?>user/detail_entreprise/<?php echo($key['student_id']) ?>" class="text-muted pull-right">
				<i class="fa fa-refresh"> retourner en arrière!</i>
			</a>
		</div>
	</div>
	<form class="row" method="post" enctype="multipart/form-data" action="<?= base_url(); ?>user/operationProjet/modification/<?php echo($codeP) ?>">
