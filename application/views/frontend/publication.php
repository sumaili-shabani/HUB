    ...
    <div id="aboutSection" class="container space-2 space-lg-3 mt-1">
      ...
      <div class="col-md-12">
        <div class="row">
          <div class="col-md-8">
            <!-- contenu -->
            <input type="hidden" placeholder="Idpublication" name="idpub" id="idpub" class="form-control" value="<?php echo($idpub) ?>">
          ...
          <div class="col-md-4 text-primary">
            <!-- menunpub -->
            <?php include("component/_menuArticle.php") ?>
  ...
  <script type="text/javascript">
      ...
      */
      ...
      function load_country_data2(page)
      {
        ...
        var idcat = $("#idpub").val();
        $.ajax({
          url:"<?php echo base_url(); ?>home/pagination_access_our_article_bycat/"+page,
          method:"POST",
          dataType:"json",
          data:{
            idcat: idcat
