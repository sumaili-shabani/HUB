  ...
  <script src="<?php echo base_url(); ?>js/dev/assets/js/vendor.min.js"></script>

  <script src="<?php echo base_url(); ?>js/dev/assets/vendor/hs-scroll-nav/dist/hs-scroll-nav.min.js"></script>

  <!-- JS Front -->
  <script src="<?php echo base_url(); ?>js/dev/assets/js/theme.min.js"></script>

  
  <!-- IE Support -->
  <script>
    if (/MSIE \d|Trident.*rv:/.test(navigator.userAgent)) document.write('<script src="<?php echo base_url(); ?>js/dev/assets/vendor/babel-polyfill/dist/polyfill.js"><\/script>');
  </script>
