 <div class="rounded-lg mx-3 mx-md-8 mt-4" 
    style="background: url(<?php echo base_url(); ?>js/dev/assets/svg/components/three-pointers.svg) center no-repeat;">
        ...
        <div class="row justify-content-lg-center">
          ...
          <div class="col-md-4 mb-7 mb-md-0">
            ...
            <a class="d-block text-center column-divider-md column-divider-20deg px-md-3" href="#">
              <img class="clients mb-3" src="<?php echo base_url(); ?>js/dev/assets/svg/icons/car.svg" alt="Image Description">
              <span class="d-block h2">+500</span>
              <p class="text-body">Entrepreneurs formés</p>
            </a>
            <!-- End Stats -->
          </div>
