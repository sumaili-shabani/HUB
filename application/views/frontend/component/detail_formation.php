				...
				if ($offre_tag->num_rows() <= 0) {
					...
					foreach ($offre_tag->result_array() as $row) {
					              ...
					              <div class="col-md-12">
					                ...
					                <div class="row">
					                  ...
					                  <div class="col-md-4">
					                    ...
					                    <div class="col-md-12 form-inline pull-right text-center mt-2">
							...
							if ($row['fin_inscription'] >= $jour) {
				                		...
				                		<div class="col-md-12">
				                			...
				                			<div class="col-md-12 card">
							                    <form class="row card-body" method="POST" 
							                     action="<?php echo(base_url()) ?>home/operation_inscription_formations">
								...
								?>
								  <a class="btn btn-dark btn-sm" href="<?php echo(base_url()) ?>home/formation"><i class="fa fa-eye"></i> voir plus de formations</a>
								<?php
							}
