<div class="w-md-60 w-lg-50 mx-auto mb-7">
    <div class="text-dark">
    ...
    <div class="row">
      ...
      <div class="col-md-4">
        ...
        <div class="card" style="width: 18rem;">
          <div class="card-body">
            <div class="card-header text-center">
              <img src="<?php echo base_url(); ?>js/dev/assets/img/avatar/45144.png" style="width: 100px; text-align: center;">
            </div>
            <h5 class="card-title">APPELLEZ-NOUS</h5>
            <p class="card-text">
